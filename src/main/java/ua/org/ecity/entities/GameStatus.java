...
public enum GameStatus {
    ...
    NO_CITY(10, "There isn't city in the base"),
    CITY_USE(11, "The City was use in game"),
    WRONG_CITY_LETTER(12, "The City start on wrong letter"),
    WINNER_PLAYER_1(20, " Winner Player 1"),
    WINNER_PLAYER_2(21, " Winner Player 2"),
